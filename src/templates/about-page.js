			...
			<div className="about-us-bottom">
				<div className="member member-odd">
					<div className="member-container">
						...
						<div className="member-text">
							<h2>Melanie Do</h2>
							<p><strong><a target="_blank" href="https://www.instagram.com/melaniedo.eo/">@melaniedo.eo</a></strong></p>
				...
				<div className="member">
					<div className="member-container">
						...
						<div className="member-text">
							<h2>Rachel Garcia</h2>
							<p><strong><a target="_blank" href="https://www.instagram.com/workout_withrachel/">@workout_withrachel</a></strong></p>
				...
				<div className="member member-odd">
					<div className="member-container">
						...
						<div className="member-text">
							<h2>Luanne Hardin</h2>
							<p><strong><a target="_blank" href="https://www.instagram.com/lively.living.with.luanne/">@lively.living.with.luanne</a></strong></p>
				...
				<div className="member">
					<div className="member-container">
						...
						<div className="member-text">
							<h2>Julia Lee</h2>
							<p><strong><a target="_blank" href="https://www.instagram.com/the.living.collective/">@the.living.collective</a></strong></p>
				...
				<div className="member member-odd">
					<div className="member-container">
						...
						<div className="member-text">
							...
							<p><strong><a target="_blank" href="https://www.instagram.com/kayla.spindler/">@kayla.spindler</a></strong></p>
				...
				<div className="member">
					<div className="member-container">
						...
						<div className="member-text">
							...
							<p><strong><a target="_blank" href="https://www.instagram.com/leahjoturner/">@leahjoturner</a></strong></p>
